...
python manage.py collectstatic --settings=qnd11_app_pro.settings.pro --noinput 
...
uwsgi  --workers 9 --master --enable-threads --module qnd11_app_pro.wsgi  --ini uwsgi_prod.ini
